...
invalidate_cache_region(unsigned char *begin, unsigned char *end)
{
...
{                                                                             \
  ...
  u32 block_tag;                                                              \
  u8 *block_address;                                                          \
  u8 *old_rom_translation_ptr = rom_translation_ptr;                          \
  u8 *old_ram_translation_ptr = ram_translation_ptr;                          \
  u8 *old_bios_translation_ptr = bios_translation_ptr;                        \
                                                                              \
  ...
  {                                                                           \
    ...
    default:                                                                  \
      ...
      break;                                                                  \
                                                                              ...
                                                                              \
  if(translation_recursion_level == 0) {                                      \
    if (rom_translation_ptr > old_rom_translation_ptr)                        \
	  invalidate_cache_region(old_rom_translation_ptr, rom_translation_ptr);  \
    if (ram_translation_ptr > old_ram_translation_ptr)                        \
	  invalidate_cache_region(old_ram_translation_ptr, ram_translation_ptr);  \
    if (bios_translation_ptr > old_bios_translation_ptr)                      \
	  invalidate_cache_region(old_bios_translation_ptr, bios_translation_ptr);\
  }                                                                           \
